...
def createQuestion(page):
    ...
    page.get_by_text("A - Average").click()
    page.get_by_text("D - Difficult").click()
    page.get_by_text("E - Easy").click()
    page.locator("#blooms-input").select_option("2")
    page.locator("#blooms-input").select_option("1")
    page.locator("#blooms-input").select_option("4")
    page.locator("#blooms-input").select_option("6")
    page.locator("#blooms-input").select_option("3")
    page.locator("#blooms-input").select_option("5")
    ...
    page.locator("#Wook-input").select_option("1")
    page.locator("#Wook-input").select_option("4")
    page.locator("#Wook-input").select_option("3")
    page.locator("#Wook-input").select_option("2")
